...
const addNewPost = {
    render() {
        return /*html*/ `
            ...
            <form action="" id="add_post" class="border w-[1400px] mx-auto p-[30px]">
              
                <label for="" class="text-[17px] font-bold">Tiêu đề bài viết</label> <br>
                <input type="text" placeholder="Tiêu đề bài viết..." id="title_post"
                ...
                <button class="border p-[20px] rounded-[30px] mt-[20px] w-[200px] text-[18px] font-bold text-white bg-blue-400 hover:bg-blue-600 ">Thêm bài viết</button> 
              </form>
            </div>
        `;
    },
    afterRender() {
      const formAdd = document.querySelector("#add_post");
